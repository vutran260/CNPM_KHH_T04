...
<div class="container">
		...
		<div id="content">
			<div class="xemtn" style="width: 998px; margin: 0px auto;">
				...
				<table class="table">
				<tr>
					<td style="text-align:left; font-weight:bold;width:200px; border-bottom:2px solid #ddd">Người gửi</td>
					<td style="text-align:left; font-weight:bold;width:auto; border-bottom:2px solid #ddd">Tiêu đề</td>
